...
def help_message1():
    """
    None -> Embed
    Fonction qui fait une mise en page des différents champs
    """
...
def help_message2():
    ...
    message = discord.Embed(
        title=f'Salon sentiment ({channelSentiment} actuellement)',
        description='La commande ci-dessous est utilisable seulement dans le salon sentiment',
        colour=discord.Colour.light_grey()
    )

    message.add_field(
        name='!setSentiment [nom]', value='Change le nom du salon sentiment par le nouveau', inline=False)
...
def help_message3():
    ...
    message = discord.Embed(
        title=f'Salon accueil ({channelAccueil} actuellement)',
        description='La commande ci-dessous est utilisable seulement dans le salon accueil',
        colour=discord.Colour.light_grey()
    )

    message.add_field(
        name='!setAccueil [nom]', value='Change le nom du salon d’accueil par le nouveau', inline=False)
